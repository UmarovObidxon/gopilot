...
import "../../css/blogfooter.css/blogfooter.css"
import Nav from 'react-bootstrap/Nav';
export default function Footer(props) {
  return (
    <>
    <div className="footer container-fluid mt-4">
 <div className=" col-xl-12  d-flex row text-center text-light">
  <div className="divfooter2  col-xl-3  col-md-3 col-sm-12 mt-2">
        ...
        <div className="containerbody2"></div>
             <div className="footerdiv1 col-12 col-xl-12 col-md-12 col-sm-12 row gap-5  justify-content-md-start d-flex ">
            
                <div className="col-xl-1 col-md-4 col-sm-5 col-5 mt-2 "><img className='card-img img-fluid' src={props.data.img3} alt="" /></div>
                <div className="col-xl-1 col-md-4 col-sm-5 col-5 mt-2"><img className='card-img img-fluid' src={props.data.img4} alt="" /></div>
            
                <div className="col-xl-1 col-md-4 col-sm-5 col-5 mt-2"> <img className='card-img img-fluid' src={props.data.img5} alt="" /></div>
                <div className="col-xl-1 col-md-4 col-sm-5 col-5 mt-2"> <img className='card-img img-fluid' src={props.data.img5} alt="" /></div>

           
               <div className="col-xl-1 col-md-4 col-sm-5 col-5 mt-2"><img className='card-img img-fluid' src={props.data.img6} alt="" /></div>
               <div className="col-xl-1 col-md-4 col-sm-5 col-5 mt-2"><img className='card-img img-fluid' src={props.data.img7} alt="" /></div>      

            
             </div>

             <div  className=' divfooter3 col-xl-12 col-md-12 col-sm-12 col-12 d-flex  text-center gap-3  justify-content-center'>
